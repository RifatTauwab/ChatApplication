...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setText("tauwab");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!username.isEmpty() && !password.isEmpty()){
            client.send(new Message("login", username, password, "SERVER"));
                ...
                jTextArea1.append("[Application] : Server down\n");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       // String target = jList1.getModel().toString();
        if(msg.contains(":"))
        {
            String[] splitsMsg=msg.split(":");
            
            jTextField4.setText("");
            client.send(new Message("message", username, splitsMsg[1], splitsMsg[0].trim()));
        }
        //msg = msg+" "+target;
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // TODO add your handling code here:
        //client.send(new Message("message", username, "left room", "All"));
